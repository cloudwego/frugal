...
func (self *Emulator) Run() {
	...
	for self.pc != nil {
		...
		case hir.OP_nop:
			break
		case hir.OP_ip:
			self.pv[p.Pd] = checkptr(p.Pr)
		case hir.OP_lb:
			self.uv[p.Rx] = uint64(*(*uint8)(unsafe.Pointer(uintptr(self.pv[p.Ps]) + uintptr(p.Iv))))
		case hir.OP_lw:
			self.uv[p.Rx] = uint64(*(*uint16)(unsafe.Pointer(uintptr(self.pv[p.Ps]) + uintptr(p.Iv))))
		case hir.OP_ll:
			self.uv[p.Rx] = uint64(*(*uint32)(unsafe.Pointer(uintptr(self.pv[p.Ps]) + uintptr(p.Iv))))
		case hir.OP_lq:
			self.uv[p.Rx] = *(*uint64)(unsafe.Pointer(uintptr(self.pv[p.Ps]) + uintptr(p.Iv)))
		case hir.OP_lp:
			self.pv[p.Pd] = checkptr(*(*unsafe.Pointer)(unsafe.Pointer(uintptr(self.pv[p.Ps]) + uintptr(p.Iv))))
		case hir.OP_sb:
			*(*uint8)(unsafe.Pointer(uintptr(self.pv[p.Pd]) + uintptr(p.Iv))) = uint8(self.uv[p.Rx])
		case hir.OP_sw:
			*(*uint16)(unsafe.Pointer(uintptr(self.pv[p.Pd]) + uintptr(p.Iv))) = uint16(self.uv[p.Rx])
		case hir.OP_sl:
			*(*uint32)(unsafe.Pointer(uintptr(self.pv[p.Pd]) + uintptr(p.Iv))) = uint32(self.uv[p.Rx])
		case hir.OP_sq:
			*(*uint64)(unsafe.Pointer(uintptr(self.pv[p.Pd]) + uintptr(p.Iv))) = self.uv[p.Rx]
		case hir.OP_sp:
			*(*unsafe.Pointer)(unsafe.Pointer(uintptr(self.pv[p.Pd]) + uintptr(p.Iv))) = self.pv[p.Ps]
		case hir.OP_ldaq:
			self.uv[p.Rx] = self.ar[p.Iv].U
		case hir.OP_ldap:
			self.pv[p.Pd] = checkptr(self.ar[p.Iv].P)
		case hir.OP_addp:
			self.pv[p.Pd] = checkptr(unsafe.Pointer(uintptr(self.pv[p.Ps]) + uintptr(self.uv[p.Rx])))
		case hir.OP_subp:
			self.pv[p.Pd] = checkptr(unsafe.Pointer(uintptr(self.pv[p.Ps]) - uintptr(self.uv[p.Rx])))
		case hir.OP_addpi:
			self.pv[p.Pd] = checkptr(unsafe.Pointer(uintptr(self.pv[p.Ps]) + uintptr(p.Iv)))
		case hir.OP_add:
			self.uv[p.Rz] = self.uv[p.Rx] + self.uv[p.Ry]
		case hir.OP_sub:
			self.uv[p.Rz] = self.uv[p.Rx] - self.uv[p.Ry]
		case hir.OP_addi:
			self.uv[p.Ry] = self.uv[p.Rx] + uint64(p.Iv)
		case hir.OP_muli:
			self.uv[p.Ry] = self.uv[p.Rx] * uint64(p.Iv)
		case hir.OP_andi:
			self.uv[p.Ry] = self.uv[p.Rx] & uint64(p.Iv)
		case hir.OP_xori:
			self.uv[p.Ry] = self.uv[p.Rx] ^ uint64(p.Iv)
		case hir.OP_shri:
			self.uv[p.Ry] = self.uv[p.Rx] >> p.Iv
		case hir.OP_bsi:
			self.uv[p.Ry] = self.uv[p.Rx] | (1 << p.Iv)
		case hir.OP_swapw:
			self.uv[p.Ry] = uint64(bits.ReverseBytes16(uint16(self.uv[p.Rx])))
		case hir.OP_swapl:
			self.uv[p.Ry] = uint64(bits.ReverseBytes32(uint32(self.uv[p.Rx])))
		case hir.OP_swapq:
			self.uv[p.Ry] = bits.ReverseBytes64(self.uv[p.Rx])
		case hir.OP_sxlq:
			self.uv[p.Ry] = uint64(int32(self.uv[p.Rx]))
		case hir.OP_beq:
			if self.uv[p.Rx] == self.uv[p.Ry] {
				self.pc = p.Br
			}
		case hir.OP_bne:
			if self.uv[p.Rx] != self.uv[p.Ry] {
		...
		case hir.OP_blt:
			if int64(self.uv[p.Rx]) < int64(self.uv[p.Ry]) {
				self.pc = p.Br
			}
		case hir.OP_bltu:
			if self.uv[p.Rx] < self.uv[p.Ry] {
		...
		case hir.OP_jmp:
			self.pc = p.Br
		case hir.OP_bzero:
			memclrNoHeapPointers(self.pv[p.Pd], uintptr(p.Iv))
		case hir.OP_bcopy:
			memmove(self.pv[p.Pd], self.pv[p.Ps], uintptr(self.uv[p.Rx]))
		case hir.OP_break:
			self.trap()
		...
		case hir.OP_gcall:
			fallthrough
		case hir.OP_icall:
			hir.LookupCall(p.Iv).Call(self, p)
