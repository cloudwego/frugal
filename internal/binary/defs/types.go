...
func doParseType(vt reflect.Type, def string, i *int, allowPtrs bool) (*Type, error) {
	...
	case reflect.Int64:
		tag = T_i64
	case reflect.Uint:
		return nil, utils.EUseOther(vt, "int")
	case reflect.Uint8:
		return nil, utils.EUseOther(vt, "int8")
	case reflect.Uint16:
		return nil, utils.EUseOther(vt, "int16")
	case reflect.Uint32:
		return nil, utils.EUseOther(vt, "int32")
	case reflect.Uint64:
		return nil, utils.EUseOther(vt, "int64")
	case reflect.Float32:
		return nil, utils.EUseOther(vt, "float64")
	case reflect.Float64:
		tag = T_double
	case reflect.Array:
		return nil, utils.EUseOther(vt, "[]"+vt.Elem().String())
	case reflect.Map:
		tag = T_map
	case reflect.Slice:
		break
	...
	case reflect.Struct:
		tag = T_struct
	default:
		return nil, utils.EType(vt, "unsupported type")
	}
