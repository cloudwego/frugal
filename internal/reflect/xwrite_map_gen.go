...
func xwriteMap_I08_I08(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	...
	for kp, vp := it.Next(); kp != nil; kp, vp = it.Next() {
		n--
		thrift.XBuffer.WriteByte(b, *((*int8)(kp)))
		thrift.XBuffer.WriteByte(b, *((*int8)(vp)))
	}
	return checkMapN(n)
}

func xwriteMap_I08_I16(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_I08_I32(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_I08_I64(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_I08_ENUM(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_I08_STRING(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_I08_Other(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_I16_I08(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
	...
	for kp, vp := it.Next(); kp != nil; kp, vp = it.Next() {
		n--
		thrift.XBuffer.WriteI16(b, *((*int16)(kp)))
		thrift.XBuffer.WriteByte(b, *((*int8)(vp)))
	}
	return checkMapN(n)
}

func xwriteMap_I16_I16(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_I16_I32(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_I16_I64(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_I16_ENUM(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_I16_STRING(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_I16_Other(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_I32_I08(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
	...
	for kp, vp := it.Next(); kp != nil; kp, vp = it.Next() {
		n--
		thrift.XBuffer.WriteI32(b, *((*int32)(kp)))
		thrift.XBuffer.WriteByte(b, *((*int8)(vp)))
	}
	return checkMapN(n)
}

func xwriteMap_I32_I16(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_I32_I32(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_I32_I64(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_I32_ENUM(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_I32_STRING(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_I32_Other(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_I64_I08(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
	...
	for kp, vp := it.Next(); kp != nil; kp, vp = it.Next() {
		n--
		thrift.XBuffer.WriteI64(b, *((*int64)(kp)))
		thrift.XBuffer.WriteByte(b, *((*int8)(vp)))
	}
	return checkMapN(n)
}

func xwriteMap_I64_I16(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_I64_I32(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_I64_I64(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_I64_ENUM(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_I64_STRING(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_I64_Other(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_ENUM_I08(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
	...
	for kp, vp := it.Next(); kp != nil; kp, vp = it.Next() {
		n--
		thrift.XBuffer.WriteI32(b, int32(*((*int64)(kp))))
		thrift.XBuffer.WriteByte(b, *((*int8)(vp)))
	}
	return checkMapN(n)
}

func xwriteMap_ENUM_I16(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_ENUM_I32(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_ENUM_I64(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_ENUM_ENUM(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_ENUM_STRING(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_ENUM_Other(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_STRING_I08(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_STRING_I16(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_STRING_I32(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_STRING_I64(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_STRING_ENUM(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_STRING_STRING(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_STRING_Other(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_Other_I08(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_Other_I16(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_Other_I32(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_Other_I64(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_Other_ENUM(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_Other_STRING(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
...
func xwriteMap_Other_Other(t *tType, b *thrift.XWriteBuffer, p unsafe.Pointer) error {
	n := xwriteMapHeader(t, b, p)
	if n == 0 {
		return nil
	}
