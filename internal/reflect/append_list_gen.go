...
func appendList_I08(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	t = t.V
...
func appendList_I16(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	t = t.V
	b, n, vp := appendListHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
...
func appendList_I32(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	t = t.V
	b, n, vp := appendListHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
...
func appendList_I64(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	t = t.V
	b, n, vp := appendListHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
...
func appendList_ENUM(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	t = t.V
	b, n, vp := appendListHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
...
func appendList_STRING(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	t = t.V
	b, n, vp := appendListHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
...
func appendList_Other(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	t = t.V
	b, n, vp := appendListHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	...
	for i := uint32(0); i < n; i++ {
		...
		if t.IsPointer {
			b, err = t.AppendFunc(t, b, *(*unsafe.Pointer)(vp), gb)
		} else {
			b, err = t.AppendFunc(t, b, vp, gb)
		}
		if err != nil {
			return b, err
		}
