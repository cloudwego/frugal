...
func appendMap_I08_I08(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
...
func appendMap_I08_I16(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_I08_I32(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_I08_I64(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_I08_ENUM(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_I08_STRING(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_I08_Other(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
	...
	for kp, vp := it.Next(); kp != nil; kp, vp = it.Next() {
		...
		b = append(b, *((*byte)(kp)))
		if t.V.IsPointer {
			b, err = t.V.AppendFunc(t.V, b, *(*unsafe.Pointer)(vp), gb)
		} else {
			b, err = t.V.AppendFunc(t.V, b, vp, gb)
		}
		if err != nil {
			return b, err
		}
...
func appendMap_I16_I08(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_I16_I16(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_I16_I32(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_I16_I64(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_I16_ENUM(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_I16_STRING(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_I16_Other(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_I32_I08(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_I32_I16(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_I32_I32(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_I32_I64(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_I32_ENUM(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_I32_STRING(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_I32_Other(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_I64_I08(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_I64_I16(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_I64_I32(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_I64_I64(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_I64_ENUM(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_I64_STRING(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_I64_Other(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_ENUM_I08(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_ENUM_I16(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_ENUM_I32(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_ENUM_I64(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_ENUM_ENUM(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_ENUM_STRING(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_ENUM_Other(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_STRING_I08(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_STRING_I16(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_STRING_I32(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_STRING_I64(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_STRING_ENUM(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_STRING_STRING(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_STRING_Other(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_Other_I08(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
	...
	for kp, vp := it.Next(); kp != nil; kp, vp = it.Next() {
		n--
		if t.K.IsPointer {
			b, err = t.K.AppendFunc(t.K, b, *(*unsafe.Pointer)(kp), gb)
		} else {
			b, err = t.K.AppendFunc(t.K, b, kp, gb)
		}
		if err != nil {
			return b, err
		}
...
func appendMap_Other_I16(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_Other_I32(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_Other_I64(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_Other_ENUM(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_Other_STRING(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
...
func appendMap_Other_Other(t *tType, b []byte, p unsafe.Pointer, gb *gridbuf.WriteBuffer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p, gb)
	if n == 0 {
		return b, nil
	}
