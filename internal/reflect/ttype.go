...
var noscanTypes = [256]bool{ // for mallocAbiType
	tBOOL:   true,
	tBYTE:   true,
	tDOUBLE: true,
	tI16:    true,
...
type tType struct {
	...
	// for Malloc
	MallocAbiType unsafe.Pointer // nil if noscanTypes
...
func newTType(x *defs.Type) *tType {
	...
	case reflect.Array, reflect.Map, reflect.Ptr, reflect.Slice, reflect.String, reflect.Struct:
		t.MallocAbiType = unsafe.Pointer(rvTypePtr(t.RV)) // pass to mallocgc
	}
