...
// Predefined fast paths for common map key/value combinations.

func appendMapBool(b []byte, v bool) []byte {
	if v {
		return append(b, 1)
	}
	return append(b, 0)
...
func init() {
	registerMapAppendFunc(tBOOL, tBOOL, appendMap_BOOL_BOOL)
	registerMapAppendFunc(tBOOL, tBYTE, appendMap_BOOL_I08)
	registerMapAppendFunc(tBOOL, tI16, appendMap_BOOL_I16)
	registerMapAppendFunc(tBOOL, tI32, appendMap_BOOL_I32)
	registerMapAppendFunc(tBOOL, tI64, appendMap_BOOL_I64)
	registerMapAppendFunc(tBOOL, tDOUBLE, appendMap_BOOL_I64)
	registerMapAppendFunc(tBOOL, tENUM, appendMap_BOOL_ENUM)
	registerMapAppendFunc(tBOOL, tSTRING, appendMap_BOOL_STRING)
	registerMapAppendFunc(tBOOL, tSTRUCT, appendMap_BOOL_Other)
	registerMapAppendFunc(tBOOL, tMAP, appendMap_BOOL_Other)
	registerMapAppendFunc(tBOOL, tSET, appendMap_BOOL_Other)
	registerMapAppendFunc(tBOOL, tLIST, appendMap_BOOL_Other)
	registerMapAppendFunc(tBYTE, tBYTE, appendMap_I08_I08)
	registerMapAppendFunc(tBYTE, tBOOL, appendMap_I08_BOOL)
	...
	registerMapAppendFunc(tI16, tBOOL, appendMap_I16_BOOL)
	...
	registerMapAppendFunc(tI32, tBOOL, appendMap_I32_BOOL)
	...
	registerMapAppendFunc(tI64, tBOOL, appendMap_I64_BOOL)
	...
	registerMapAppendFunc(tDOUBLE, tBOOL, appendMap_I64_BOOL)
	...
	registerMapAppendFunc(tENUM, tBOOL, appendMap_ENUM_BOOL)
	...
	registerMapAppendFunc(tSTRING, tBOOL, appendMap_STRING_BOOL)
	...
	registerMapAppendFunc(tSTRUCT, tBOOL, appendMap_Other_BOOL)
	...
	registerMapAppendFunc(tMAP, tBOOL, appendMap_Other_BOOL)
	...
	registerMapAppendFunc(tSET, tBOOL, appendMap_Other_BOOL)
	...
	registerMapAppendFunc(tLIST, tBOOL, appendMap_Other_BOOL)
...
func appendMap_BOOL_BOOL(t *tType, b []byte, p unsafe.Pointer) ([]byte, error) {
...
func appendMap_BOOL_I08(t *tType, b []byte, p unsafe.Pointer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p)
	if n == 0 {
		return b, nil
	}
	for k, v := range *(*map[bool]byte)(p) {
		n--
		b = appendMapBool(b, k)
		b = append(b, v)
	}
...
func appendMap_BOOL_I16(t *tType, b []byte, p unsafe.Pointer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p)
	if n == 0 {
		return b, nil
	}
	for k, v := range *(*map[bool]uint16)(p) {
		n--
		b = appendMapBool(b, k)
		b = appendUint16(b, v)
	}
...
func appendMap_BOOL_I32(t *tType, b []byte, p unsafe.Pointer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p)
	if n == 0 {
		return b, nil
	}
	for k, v := range *(*map[bool]uint32)(p) {
		n--
		b = appendMapBool(b, k)
		b = appendUint32(b, v)
	}
...
func appendMap_BOOL_I64(t *tType, b []byte, p unsafe.Pointer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p)
	if n == 0 {
		return b, nil
	}
	for k, v := range *(*map[bool]uint64)(p) {
		n--
		b = appendMapBool(b, k)
		b = appendUint64(b, v)
	}
...
func appendMap_BOOL_ENUM(t *tType, b []byte, p unsafe.Pointer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p)
	if n == 0 {
		return b, nil
	}
...
func appendMap_BOOL_STRING(t *tType, b []byte, p unsafe.Pointer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p)
	if n == 0 {
		return b, nil
	}
...
func appendMap_BOOL_Other(t *tType, b []byte, p unsafe.Pointer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p)
	if n == 0 {
		return b, nil
	}
...
func appendMap_I08_BOOL(t *tType, b []byte, p unsafe.Pointer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p)
	if n == 0 {
		return b, nil
	}
	for k, v := range *(*map[byte]bool)(p) {
		n--
		b = append(b, k)
		b = appendMapBool(b, v)
	}
...
func appendMap_I16_BOOL(t *tType, b []byte, p unsafe.Pointer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p)
	if n == 0 {
		return b, nil
	}
	for k, v := range *(*map[uint16]bool)(p) {
		n--
		b = appendUint16(b, k)
		b = appendMapBool(b, v)
	}
...
func appendMap_I32_BOOL(t *tType, b []byte, p unsafe.Pointer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p)
	if n == 0 {
		return b, nil
	}
	for k, v := range *(*map[uint32]bool)(p) {
		n--
		b = appendUint32(b, k)
		b = appendMapBool(b, v)
	}
...
func appendMap_I64_BOOL(t *tType, b []byte, p unsafe.Pointer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p)
	if n == 0 {
		return b, nil
	}
	for k, v := range *(*map[uint64]bool)(p) {
		n--
		b = appendUint64(b, k)
		b = appendMapBool(b, v)
	}
...
func appendMap_ENUM_BOOL(t *tType, b []byte, p unsafe.Pointer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p)
	if n == 0 {
		return b, nil
	}
...
func appendMap_STRING_BOOL(t *tType, b []byte, p unsafe.Pointer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p)
	if n == 0 {
		return b, nil
	}
...
func appendMap_Other_BOOL(t *tType, b []byte, p unsafe.Pointer) ([]byte, error) {
	b, n := appendMapHeader(t, b, p)
	if n == 0 {
		return b, nil
	}
